...
import com.sakana.dao.mapper.AdminMapper;
import com.sakana.exceptions.BizException;
import com.sakana.request.AdminLoginReq;
import com.sakana.security.AdminTokenBlacklist;
import com.sakana.services.AdminService;
 ...
 * 管理员服务实现
 *
 * <p>不通过 Spring Security AuthenticationManager，
 * 因为项目内同时存在 C 端 UserDetailsService，混用会冲突。
 * 直接用 BCrypt 校验账密后自行签发 JWT。
 */
@Slf4j
@Service
