...
import com.sakana.security.AdminSecurityUtil;
 ...
 *
 * <p>- login：公开<br>
 * - me / logout：要求 {@code ADMIN} 或 {@code SUPER_ADMIN} 角色
 */
@Slf4j
@RestController
...
public class AdminAuthController {
    ...
    public R<LoginResp> login(@Valid @RequestBody AdminLoginReq req) {
        return R.ok(adminService.login(req));
    }

    @GetMapping("/me")
    @Operation(summary = "当前管理员信息")
    public R<LoginResp.UserInfo> me() {
