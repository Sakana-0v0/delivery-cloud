...
public class ReviewCountCacheServiceImpl implements ReviewCountCacheService {
    ...
    public String getUserVote(Long userId, Long orderId, Long productId) {
        ...
        var review = reviewMapper.selectOne(
                new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<com.sakana.dao.entity.Review>()
                        .eq(com.sakana.dao.entity.Review::getUserId, userId)
                        .eq(com.sakana.dao.entity.Review::getOrderId, orderId)
                        .eq(com.sakana.dao.entity.Review::getProductId, productId)
                        .eq(com.sakana.dao.entity.Review::getIsDeleted, 0)
        );
