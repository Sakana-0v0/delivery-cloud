...
import com.sakana.review.configs.CacheInvalidateListener;
...
public class RedisConfig {
    ...
    /** 跨实例缓存失效广播频道（与 ReviewCountCacheServiceImpl 中保持一致） */
    ...
    public RedisMessageListenerContainer cacheInvalidateListenerContainer(
        ...
        container.addMessageListener(cacheInvalidateListener, new ChannelTopic(INVALIDATE_CHANNEL));
        return container;
    }
}
